		    	...
		    	<div class="widget">
		            ...
		            <div class="widget_body">
		                ...
		                <?php echo Form::open('empleados/new', array('method' => 'POST'));
							...
							echo '<ul class="form_fields_container one_two_wrap fl_left">';
								echo "<li>";
		                    		echo Form::label('entrydate', 'Fecha de ingreso');
									echo '<div class="form_input">';
									echo Form::input('entrydate', '', array('type' => 'text', 'id' => 'entrydate'));
		                        	echo '</div>';
								echo "</li>";
							echo '</ul>';
							echo '<ul class="form_fields_container one_two_wrap fl_right">';
								echo "<li>";
		                    		echo Form::label('socioid', 'Socio');
									echo '<div class="form_input">';
									echo Form::input('socioid', '', array('type' => 'text', 'id' => 'socioid'));
		                        	echo '</div>';
								echo "</li>";
							echo '</ul>';
							echo '<ul class="form_fields_container one_two_wrap fl_left">';
								echo "<li>";
		                    		echo Form::label('tarifaid', 'Tarifa');
									echo '<div class="form_input">';
									echo Form::input('tarifaid', '', array('type' => 'text', 'id' => 'tarifaid'));
		                        	echo '</div>';
								echo "</li>";
							echo '</ul>';
							echo '<ul class="form_fields_container one_two_wrap fl_right">';
								echo "<li>";
		                    		echo Form::label('tarifaespid', 'Tarifa especial');
									echo '<div class="form_input">';
									echo Form::input('tarifaespid', '', array('type' => 'text', 'id' => 'tarifaespid'));
		                        	echo '</div>';
								echo "</li>";
							echo '</ul>';
							echo '<ul class="form_fields_container one_two_wrap fl_left">';
								echo "<li>";
		                    		echo Form::label('fincatrabid', 'Finca de trabajo');
									echo '<div class="form_input">';
									echo Form::input('fincatrabid', '', array('type' => 'text', 'id' => 'fincatrabid'));
		                        	echo '</div>';
								echo "</li>";
							echo '</ul>';
							echo '<ul class="form_fields_container one_two_wrap fl_right">';
								echo "<li>";
		                    		echo Form::label('fincacobroid', 'Finca de cobro');
									echo '<div class="form_input">';
									echo Form::input('fincacobroid', '', array('type' => 'text', 'id' => 'fincacobroid'));
		                        	echo '</div>';
								echo "</li>";
		                    echo '</ul>';
		                    ...
		                    if(isset($_empleados)){
		                    	foreach($_empleados as $empleado){
		                    		echo "<tr>";
										...
										echo "<td>";
											echo "<input type='checkbox' style='opacity: 0;' name='active' id='".$empelado->Id."'";
											if($empelado->Active == Helpers_Const::ITEMACTIVE)
											{ echo " checked>"; }
											else{ echo ">"; }
										echo "</td>";
									echo "</tr>";
